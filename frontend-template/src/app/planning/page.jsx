                ...
                },
                {
                    ...
                    tasks: [
                        ...
                        },
                        {
                            ...
                            title: "Yoga Session",
                            description:
                                "Relax your body with a 30-minute yoga session.",
                            completed: false,
                        },
                        {
                            startTime: "20:00",
            ...
            schedule: [
                {
                    tasks: [
                        ...
                        },
                        {
                            ...
                            description:
                                "Have a lunch with leafy greens and healthy fats.",
                            completed: false,
                        },
                        {
                            startTime: "15:00",
                ...
                },
                {
                    tasks: [
                        ...
                        },
                        {
                            ...
                            title: "Morning Walk",
                            description:
                                "Take a 15-minute walk to prepare for the day.",
                            completed: false,
                        },
                        {
                            startTime: "12:00",
                        ...
                        },
                        {
                            ...
                            description:
                                "Have a light dinner with protein and vegetables.",
                            completed: false,
                        },
                        {
                            startTime: "21:30",
                ...
                },
                {
                    ...
                    tasks: [
                        ...
                        },
                        {
                            ...
                            description:
                                "Eat a fiber-rich dinner to promote digestion.",
                            completed: false,
                        },
                        {
                            startTime: "22:00",
                ...
                {selectedPlan ? (
                    <div>
                        ...
                        <div className="flex w-full flex-col my-4">
                            {(selectedPlan?.schedule || [])[0]?.tasks.map(
                                (task, i) => {
                                    console.log({ task });
                                    return (
                                        <div
                    ...
                    <p className="text-base-700 ">
                        No plan found for the selected day.
                    </p>
                )}
            </div>
